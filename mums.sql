...
--
-- Constraints for table `accent_bow`
--
ALTER TABLE `accent_bow`
  ADD CONSTRAINT `accent_bow_FK_1` FOREIGN KEY (`grade_id`) REFERENCES `grade` (`id`);

--
-- Constraints for table `backing`
--
ALTER TABLE `backing`
  ADD CONSTRAINT `backing_FK_1` FOREIGN KEY (`size_id`) REFERENCES `size` (`id`),
  ADD CONSTRAINT `backing_FK_2` FOREIGN KEY (`grade_id`) REFERENCES `grade` (`id`);

--
-- Constraints for table `mum_accessory`
--
ALTER TABLE `mum_accessory`
  ADD CONSTRAINT `mum_trinket_FK_1` FOREIGN KEY (`mum_id`) REFERENCES `mum` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `mum_trinket_FK_2` FOREIGN KEY (`accessory_id`) REFERENCES `accessory` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `mum_bear`
--
ALTER TABLE `mum_bear`
  ADD CONSTRAINT `mum_bear_FK_1` FOREIGN KEY (`mum_id`) REFERENCES `mum` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `mum_bear_FK_2` FOREIGN KEY (`bear_id`) REFERENCES `bear` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `password_recovery`
--
ALTER TABLE `password_recovery`
  ADD CONSTRAINT `password_recovery_FK_1` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`id`);

--
-- Constraints for table `size`
--
ALTER TABLE `size`
  ADD CONSTRAINT `size_FK_1` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`);
