 ...
 *
 * @method     ChildProductQuery leftJoinSize($relationAlias = null) Adds a LEFT JOIN clause to the query using the Size relation
 * @method     ChildProductQuery rightJoinSize($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Size relation
 * @method     ChildProductQuery innerJoinSize($relationAlias = null) Adds a INNER JOIN clause to the query using the Size relation
 *
 ...
 * @method     array findByName(string $name) Return ChildProduct objects filtered by the name column
 *
 */
abstract class ProductQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'mums', $modelName = '\\Product', $modelAlias = null)
    {
    ...
    public function filterByName($name = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ProductTableMap::NAME, $name, $comparison);
    }

    /**
     * Filter the query by a related \Size object
     *
     * @param \Size|ObjectCollection $size  the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildProductQuery The current query, for fluid interface
     */
    public function filterBySize($size, $comparison = null)
    {
        if ($size instanceof \Size) {
            return $this
                ->addUsingAlias(ProductTableMap::ID, $size->getProductId(), $comparison);
        } elseif ($size instanceof ObjectCollection) {
            return $this
                ->useSizeQuery()
                ->filterByPrimaryKeys($size->getPrimaryKeys())
                ->endUse();
        } else {
