...
abstract class Backing implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\BackingTableMap';
    ...
    /**
     * Initializes internal state of Base\Backing object.
     */
    ...
    /**
     * Compares this with another <code>Backing</code> instance.  If
     * <code>obj</code> is an instance of <code>Backing</code>, delegates to
     * <code>equals(Backing)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return Backing The current object, for fluid interface
     */
    ...
    protected function loadImage(ConnectionInterface $con = null)
    {
        ...
        $c->addSelectColumn(BackingTableMap::IMAGE);
        try {
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = BackingTableMap::ID;
        }
    ...
    public function setItemId($v)
    {
        ...
        if ($this->item_id !== $v) {
            $this->item_id = $v;
            $this->modifiedColumns[] = BackingTableMap::ITEM_ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = BackingTableMap::NAME;
        }
    ...
    public function setPrice($v)
    {
        ...
        if ($this->price !== $v) {
            $this->price = $v;
            $this->modifiedColumns[] = BackingTableMap::PRICE;
        }
    ...
    public function setSizeId($v)
    {
        ...
        if ($this->size_id !== $v) {
            $this->size_id = $v;
            $this->modifiedColumns[] = BackingTableMap::SIZE_ID;
        }
    ...
    public function setGradeId($v)
    {
        ...
        if ($this->grade_id !== $v) {
            $this->grade_id = $v;
            $this->modifiedColumns[] = BackingTableMap::GRADE_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : BackingTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : BackingTableMap::translateFieldName('ItemId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->item_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : BackingTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : BackingTableMap::translateFieldName('Price', TableMap::TYPE_PHPNAME, $indexType)];
            $this->price = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : BackingTableMap::translateFieldName('SizeId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->size_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : BackingTableMap::translateFieldName('GradeId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 6; // 6 = BackingTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \Backing object", 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildBackingQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
        $row = $dataFetcher->fetch();
        $dataFetcher->close();
        if (!$row) {
     ...
     * @return void
     * @throws PropelException
     * @see Backing::setDeleted()
     * @see Backing::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildBackingQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BackingTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(BackingTableMap::ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(BackingTableMap::ITEM_ID)) {
            $modifiedColumns[':p' . $index++]  = 'ITEM_ID';
        }
        if ($this->isColumnModified(BackingTableMap::NAME)) {
            $modifiedColumns[':p' . $index++]  = 'NAME';
        }
        if ($this->isColumnModified(BackingTableMap::PRICE)) {
            $modifiedColumns[':p' . $index++]  = 'PRICE';
        }
        if ($this->isColumnModified(BackingTableMap::SIZE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'SIZE_ID';
        }
        if ($this->isColumnModified(BackingTableMap::GRADE_ID)) {
    ...
    {
        $pos = BackingTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Backing'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Backing'][$this->getPrimaryKey()] = true;
        $keys = BackingTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BackingTableMap::ID)) $criteria->add(BackingTableMap::ID, $this->id);
        if ($this->isColumnModified(BackingTableMap::ITEM_ID)) $criteria->add(BackingTableMap::ITEM_ID, $this->item_id);
        if ($this->isColumnModified(BackingTableMap::NAME)) $criteria->add(BackingTableMap::NAME, $this->name);
        if ($this->isColumnModified(BackingTableMap::PRICE)) $criteria->add(BackingTableMap::PRICE, $this->price);
    ...
    {
        $criteria = new Criteria(BackingTableMap::DATABASE_NAME);
        $criteria->add(BackingTableMap::ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Backing (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Backing Clone of current object.
     * @throws PropelException
     */
    ...
    /**
     * Declares an association between this object and a ChildSize object.
     *
     * @param                  ChildSize $v
     * @return                 \Backing The current object (for fluent API support)
     * @throws PropelException
     */
    public function setSize(ChildSize $v = null)
    {
        if ($v === null) {
            $this->setSizeId(NULL);
        } else {
        ...
        // If this object has already been added to the ChildSize object, it will not be re-added.
        if ($v !== null) {
            $v->addBacking($this);
        }
    ...
    /**
     * Get the associated ChildSize object
     *
     * @param      ConnectionInterface $con Optional Connection object.
     * @return                 ChildSize The associated ChildSize object.
     * @throws PropelException
     */
    public function getSize(ConnectionInterface $con = null)
    {
        if ($this->aSize === null && ($this->size_id !== null)) {
            $this->aSize = ChildSizeQuery::create()->findPk($this->size_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSize->addBackings($this);
             */
        }
     ...
     * If this ChildBacking is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return   ChildBacking The current object (for fluent API support)
     */
     ...
     * Otherwise if this Backing is new, it will return
     * an empty collection; or if this Backing has previously
     * been saved, it will retrieve related Mums from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Backing.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(BackingTableMap::DEFAULT_STRING_FORMAT);
    }
