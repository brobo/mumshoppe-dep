...
abstract class MumTrinket implements ActiveRecordInterface
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : MumTrinketTableMap::translateFieldName('MumId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mum_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : MumTrinketTableMap::translateFieldName('TrinketId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = MumTrinketTableMap::NUM_HYDRATE_COLUMNS.
    ...
    {
        if (isset($alreadyDumpedObjects['MumTrinket'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['MumTrinket'][serialize($this->getPrimaryKey())] = true;
        $keys = MumTrinketTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getMumId(),
            $keys[1] => $this->getTrinketId(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setTrinketId($arr[$keys[1]]);
    }
    ...
    {
        $criteria = new Criteria(MumTrinketTableMap::DATABASE_NAME);
        $criteria->add(MumTrinketTableMap::MUM_ID, $this->mum_id);
        $criteria->add(MumTrinketTableMap::TRINKET_ID, $this->trinket_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getMumId()) && (null === $this->getTrinketId());
    }
